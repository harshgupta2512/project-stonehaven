    ...
    <section id="residences" className={styles.residences}>
      ...
      <div className={styles['scene--full']}>
        ...
        >
          ...
          <h2 className={styles['scene--full__heading']}>Light-Filled<br/>Living</h2>
          <p className="section-body--inverse">
            Light-filled open-plan living and dining with seamless indoor-outdoor flow. Natural tones and brushed brass highlights create warmth and rhythm.
          </p>
        </motion.div>
      </div>

      {/* Scene 2: Inset — Living & Dining 1 (Light Theme / 1) */}
        ...
        <div className="container">
          <div className={styles['scene--inset__grid']}>
            <motion.div
              ...
              variants={fadeUpVars}
            >
              <img src="images/1_Living & dining.jpg" alt="Residence 1 Living and Dining" className={styles['scene--inset__image']} loading="lazy" />
            </motion.div>
            ...
            >
              ...
              <h2 className="section-heading section-heading--dark">Designed for<br/>Gathering</h2>
      ...
      {/* Scene 3: Full-bleed — Kitchen 1A (Dark Theme / 1A) */}
      <div className={styles['scene--full']}>
        <div className={styles['scene--full__bg']} style={{ backgroundImage: "url('images/1A kitchen.jpg')" }}></div>
        <div className={styles['scene--full__overlay']}></div>
        <motion.div 
          className={styles['scene--full__content']}
          initial="hidden"
        ...
        >
          ...
          <p className="section-body--inverse">
            Cafe oak, darker tone accents and brushed gunmetal detailing — a more dramatic expression that creates spaces of quiet confidence and refined edge.
          </p>
        </motion.div>
      </div>
      ...
      <div className={`${styles['scene--inset']} ${styles['scene--inset-light']} ${styles['scene--inset-reverse']}`}>
        <div className="container">
          <div className={styles['scene--inset__grid']}>
            ...
            >
              <img src="images/Stonehaven_Cam_2_Exterior.jpg" alt="Stonehaven Architecture" className={styles['scene--inset__image']} loading="lazy" />
            </motion.div>
          </div>
        </div>
      </div>
